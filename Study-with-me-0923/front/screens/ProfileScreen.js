...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#002B5B', padding: 10, marginTop: 32 },
  loadingContainer: { flex: 1, justifyContent: 'center', alignItems: 'center' },
  header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#002B5B', paddingHorizontal: 10, height: 40 },
  backButton: { marginLeft: 5 },
  menuIcon: { marginRight: -5 },
  card: { flex: 1, backgroundColor: '#FFFFFF', borderRadius: 20, padding: 20, marginTop: 10,marginBottom: 50, },
